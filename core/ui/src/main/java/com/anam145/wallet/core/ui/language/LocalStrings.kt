...
private fun getKoreanStringsForSkin(skin: Skin): Strings {
    ...
    return when (skin) {
        ...
        Skin.RWANDA -> baseStrings.copy(
            headerTitle = "Rwanda Wallet",
            headerTitleMain = "Rwanda Wallet",
            settingsAppInfoDescription = "Rwanda Wallet에 대해 알아보기",
            loginTitle = "비밀번호를 입력하여 Rwanda Wallet에 접근하세요"
        )
    }
}
...
private fun getEnglishStringsForSkin(skin: Skin): Strings {
    ...
    return when (skin) {
        ...
        Skin.RWANDA -> baseStrings.copy(
            headerTitle = "Rwanda Wallet",
            headerTitleMain = "Rwanda Wallet",
            settingsAppInfoDescription = "Learn about Rwanda Wallet",
            loginTitle = "Enter password to access your Rwanda Wallet"
        )
    }
}